...
export const Users = () => {
    ...
    const { data: { data }, isLoading, error } = Api({ service: services.users.list })
    return (
        <div>
                ...
                <div className="col-12">
                    <div className="card card-background card-background-after-none align-items-start mt-4 mb-5">
                        ...
                        <div className="card-body text-start p-4 w-100">
                            <h3 className="text-white mb-2">Users 🔥</h3>
                ...
                <div className="col-lg-4 col-md-6 mb-md-0 mb-4">
                    <div className="card shadow-xs border h-100">
                        <div className="card-header pb-0">
                            <h6 className="font-weight-semibold text-lg mb-0">Users over time</h6>
                            ...
                            <div className="table-responsive p-0">
                                <table className="table align-items-center justify-content-center mb-0">
                                    <thead className="bg-gray-100">
                                        <tr>
                                            <th className="text-secondary text-xs font-weight-semibold opacity-7">User</th>
                                    ...
                                    <tbody>
                                        {data?.map((user: any) =>
                                            <tr>
                                                <td>
                                                    <div className="d-flex px-2">
                                                        ...
                                                        <div className="my-auto">
                                                            <h6 className="mb-0 text-sm">{user?.datas?.firstName} {user?.datas?.lastName}</h6>
                                                            <p className="text-sm font-weight-normal mb-0">{user?.email}</p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span className="text-sm font-weight-normal">{user?.createdAt}</span>
                                                </td>
                                                <td className="align-middle">
                                                    <div className="d-flex">
                                                        ...
                                                        <div className="ms-2">
                                                            <p className="text-dark text-sm mb-0">{user?.roles}</p>
