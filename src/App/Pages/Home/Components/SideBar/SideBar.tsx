      ...
      >
        <ul className="navbar-nav">
          ...
          <li className="nav-item mt-2">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="ms-2" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="card border-radius-md" id="sidenavCard">
          <div className="card-body  text-start  p-3 w-100">
            ...
            <div className="docs-info">
              <h6 className="font-weight-bold up mb-2">Precisa de alguam ajuda?</h6>
